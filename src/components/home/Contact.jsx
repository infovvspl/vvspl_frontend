...
const Contact = ({ innerRef }) => {
  return (
    <section
      ref={innerRef}
      className="tunnel-section absolute inset-0 flex items-center justify-center bg-white text-zinc-900 overflow-hidden opacity-0 p-6 md:p-12"
    >
      {/* Background Layer */}
      ...
      <div className="relative z-10 w-full max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
          ...
          {/* Left: Heading & Info */}
          <div>
            <span className="text-blue-600 font-mono text-xs tracking-[1em] uppercase mb-8 block font-bold">Contact Us</span>
            <h2 className="text-7xl md:text-8xl font-black uppercase italic tracking-tighter leading-[0.85] text-zinc-900 underline decoration-blue-600/10 decoration-8 underline-offset-[16px]">
              Start your <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-zinc-400">Journey</span>
            </h2>

            <div className="mt-20 space-y-12">
              <div className="group cursor-pointer">
                <p className="text-zinc-400 font-mono text-[10px] uppercase tracking-widest mb-2">New Projects</p>
                <h4 className="text-2xl font-bold text-zinc-800 group-hover:text-blue-600 transition-colors">info@vvspltech.com</h4>
              </div>
              <div className="group cursor-pointer">
                <p className="text-zinc-400 font-mono text-[10px] uppercase tracking-widest mb-2">Social Hub</p>
                <div className="flex gap-8 mt-4">
                  {['TW', 'LN', 'IG'].map(s => (
                    <span key={s} className="text-sm font-black text-zinc-800 uppercase tracking-wider hover:text-blue-600 transition-colors">
                      {s}
                    </span>
                  ))}
                </div>
