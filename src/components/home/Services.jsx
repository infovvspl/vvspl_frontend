...
const Services = ({ innerRef, isPage = false }) => {
  ...
  return (
    ...
    >
      ...
      <div ref={headerRef} className={`${isPage ? 'relative mb-12 translate-y-0 opacity-100' : 'absolute top-16'} left-8 md:left-16 z-20`}>
      ...
      >
        {serviceList.map((s, i) => (
          <div
            key={i}
            className={`relative w-[85vw] md:w-[45vw] lg:w-[32vw] h-[60vh] md:h-[65vh] flex-shrink-0 group overflow-hidden border border-white/10 bg-zinc-900/40 backdrop-blur-xl transition-colors duration-500 hover:border-blue-500/50 ${isPage ? 'm-4 h-[50vh]' : ''}`}
          >
            {/* Image Layer */}
            ...
            <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-end">
              ...
              <p className="text-white text-sm md:text-lg font-light mb-8 max-w-xs leading-relaxed">
                {s.desc}
              </p>
