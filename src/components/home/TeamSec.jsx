  ...
  const founders = [
    {
      ...
      img: H1,
      linkedin:
        "https://in.linkedin.com/in/anil-tripathi-13887819?utm_source=share&utm_medium=member_mweb&utm_campaign=share_via&utm_content=profile",
    },
    {
      name: "Ankit Tripathi",
    ...
    },
    {
      ...
      img: H3,
      linkedin:
        "https://in.linkedin.com/in/dattavii?utm_source=share&utm_medium=member_mweb&utm_campaign=share_via&utm_content=profile",
    },
    {
      ...
      img: H4,
      linkedin:
        "https://ch.linkedin.com/in/priyankatripathi91?utm_source=share&utm_medium=member_mweb&utm_campaign=share_via&utm_content=profile",
    },
  ];
        ...
        >
          {founders.map((founder, i) => (
            <div key={i} className="group flex flex-col h-full">
              ...
              {/* Content Below Image */}
              {/* Added flex-grow and flex-col to keep icon at the bottom */}
              <div className="mt-5 text-center px-2 flex flex-col flex-grow items-center">
                {/* Wrap text in a growable container */}
                ...
                {/* This icon will now always sit at the same relative bottom position */}
                <a
                  href={founder.linkedin}
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label={`${founder.name} LinkedIn`}
                  className="mt-6 inline-flex items-center justify-center w-10 h-10 rounded-full border border-white/15 text-zinc-300 hover:text-white hover:border-cyan-400/60 hover:bg-cyan-500/10 transition-colors duration-300"
                >
                  <Linkedin size={18} />
                </a>
              </div>
