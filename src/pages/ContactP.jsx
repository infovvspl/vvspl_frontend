...
const ContactPage = () => {
  ...
  const faqs = [
    {
      ...
      a: "We aim to respond to all enquiries within 24 hours on business days. Urgent matters can be flagged in your message subject.",
    },
    {
      q: "Do you work with international clients?",
      a: "Absolutely. We work with clients across 15+ countries and are experienced in managing remote collaboration, time zones, and cross-border engagements.",
    },
    {
      q: "Can I schedule a call before committing to a project?",
      a: "Yes —  we offer a free, no obligation 30-minute discovery call to understand your needs and see if we are a good fit.",
    },
    {
      q: "How do engagements typically start?",
      a: "After an initial consultation, we prepare a scoped proposal with timelines and deliverables. Projects typically kick off within 1–2 weeks of agreement.",
    },
  ];
  ...
  return (
    <div
      ref={mainRef}
      className="bg-white text-zinc-900 font-sans selection:bg-indigo-100"
    >
      <Navbar />
      ...
      <section className="hero-container relative py-32 flex flex-col items-center justify-center overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <p className="hero-sub text-base md:text-xl text-zinc-400 leading-relaxed max-w-xl mx-auto">
            Whether it's a project, a partnership, or just a conversation — we'd
            love to hear from you. We respond within 24 hours.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
            ...
            >
              ...
              <p className="text-sm text-zinc-600 font-medium leading-relaxed">
                Block-309/310, ODYSSA Business Center, Rasulgarh, Bhubaneswar,
                751010
              </p>
            </a>
            ...
            >
              ...
              <p className="text-sm text-zinc-500">Mon–Sat, 9am – 6pm GST</p>
            </a>
            ...
            <div className="group relative p-6 rounded-2xl border border-zinc-200 bg-white hover:border-violet-500/30 hover:bg-zinc-50 transition-all duration-500 shadow-sm">
              ...
              <div className="flex gap-5 text-xl">
                <a
                  href="https://www.facebook.com/people/Veteran-Ventures/61587637222712/?rdid=aRhPjXPEbEqyOCaA&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1D4x5YWeff%2F"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-zinc-500 hover:text-blue-600 transition transform hover:scale-110"
                >
                  <FaFacebookF />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-zinc-500 hover:text-green-500 transition transform hover:scale-110"
                >
                  <FaWhatsapp />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-zinc-500 hover:text-pink-500 transition transform hover:scale-110"
                >
                  <FaInstagram />
                </a>
                <a
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 lg:gap-20 items-start">
              ...
              {status === "sent" ? (
                <div className="flex flex-col items-center justify-center text-center py-20 gap-6">
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded-full border border-zinc-200 text-sm hover:bg-zinc-50 transition-all"
                  >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="flex flex-col gap-2">
                      ...
                      <input
                        ...
                        className="w-full bg-zinc-100 border border-zinc-200 rounded-xl px-5 py-3.5 text-sm focus:bg-white focus:border-indigo-500/40 outline-none transition-all"
                        placeholder="Mukesh Bose"
                      />
                    </div>
                    <div className="flex flex-col gap-2">
                      <label className="text-[10px] tracking-widest uppercase text-zinc-500 font-bold">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      required
                      onChange={handleChange}
                      className="w-full bg-zinc-100 border border-zinc-200 rounded-xl px-5 py-3.5 text-sm focus:bg-white outline-none transition-all resize-none"
            ...
            <div className="flex flex-col gap-6 lg:pt-[88px]">
              <div className="reveal-up p-7 rounded-2xl border border-zinc-200 bg-white shadow-sm relative overflow-hidden">
                ...
                <p className="text-[10px] tracking-[0.4em] uppercase text-indigo-600 mb-4 font-bold">
                  Why Work With Us
                </p>
              ...
              <div className="reveal-up relative rounded-3xl overflow-hidden border border-zinc-200 h-64 md:h-80">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-5 py-2 rounded-full border border-white/20 text-xs text-white hover:bg-white/10 transition-all backdrop-blur-sm inline-block text-center"
                  >
                    Open in Maps ↗
                  </a>
                </div>
        ...
        <div className="max-w-[1300px] mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="reveal-up">
              ...
              <h2 className="text-3xl md:text-5xl font-black leading-[1.1] text-zinc-900">
                Before you{" "}
                <span
                  className="text-transparent"
            ...
            <div className="flex flex-col border-t border-zinc-200">
              {faqs.map((faq, i) => (
                <div key={i} className="reveal-up border-b border-zinc-200">
                  ...
                  >
                    <span className="text-sm md:text-base font-bold text-zinc-800 group-hover:text-indigo-600 transition-colors">
                      {faq.q}
                    </span>
                    <span
                      className={`text-indigo-600 text-xl transition-transform duration-300 ${openFaq === i ? "rotate-45" : ""}`}
                    >
                      +
                    </span>
                  </button>
                  <div
                    className={`overflow-hidden transition-all duration-300 ${openFaq === i ? "max-h-40 pb-6 opacity-100" : "max-h-0 opacity-0"}`}
                  >
                    <p className="text-sm text-zinc-600 font-medium leading-relaxed">
                      {faq.a}
                    </p>
      ...
      <section className="reveal-up relative py-24 overflow-hidden bg-zinc-900 text-center text-white">
        ...
        <div className="relative z-10 px-6 max-w-2xl mx-auto">
          <p className="text-[10px] tracking-[0.5em] uppercase font-semibold bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent mb-5">
            Prefer a Call?
          </p>
