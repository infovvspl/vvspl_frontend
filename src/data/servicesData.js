export const SERVICES = [
  ...
  },
  {
    ...
    tag: "Growth",
    description:
      "End-to-end digital marketing strategies designed to attract, engage, and convert. From performance advertising and SEO to social media management and brand storytelling — we build measurable growth engines powered by data and creativity.",
    features: [
      {
        name: "Search Engine Optimisation (SEO)",
        desc: "Technical audits, on-page optimisation, and authority building strategies to improve rankings and drive organic traffic.",
      },
      {
        name: "Performance Marketing",
        desc: "ROI-focused campaigns across Google Ads, Meta Ads, and programmatic platforms with continuous A/B testing and optimisation.",
      },
      {
        name: "Social Media Management",
        desc: "Strategic content calendars, community management, and paid amplification to grow and engage your audience.",
      },
      {
        name: "Content Marketing",
        desc: "High-quality blogs, landing pages, and multimedia content crafted to educate users and strengthen brand authority.",
      },
      {
        name: "Email & Automation",
        desc: "Customer journey automation, drip campaigns, and CRM integrations to nurture leads and increase lifetime value.",
      },
      {
        name: "Analytics & Conversion Tracking",
        desc: "Advanced tracking setup with GA4, pixels, and dashboards to measure campaign performance and optimise conversion funnels.",
      },
    ],
    techStack: [
      "Google Ads",
